...
public class App {
    ...
    public static void showUserMenu() {
        ...
        do {
            ...
            System.out.println("6: Get User By ID and Password");
            ...
            switch (userSelected) {
                ...
                userController.update(updateId, updatedUser);
                ...
                System.out.println("Enter User Id you want to get : ");
                int getId = sc.nextInt();
                sc.nextLine();
            
                User getUser = userController.getUserById(getId);
                if (getUser != null) {
                    getUser.getUserInfo();
                    } else {
                ...
                sc.nextLine();
                System.out.println("Enter User Password: ");
                String searchUserPassword = sc.nextLine();
                User userByPassword = userController.getUserByEmailAndPassword(searchUserId, searchUserPassword);
                if (userByPassword != null) {
                    System.out.println("---------------------");
                    userByPassword.getUserInfo();
                    System.out.println("---------------------");
                    } else {
